...
function ContactIcon({ name }) {
  ...
  if (name === 'phone') {
    return (
      <svg viewBox="0 0 24 24" fill="none" className={iconClass} aria-hidden="true">
        <path
          d="M8.2 5.3c.4-.4 1-.5 1.5-.2l1.8 1c.6.3.8 1 .5 1.6l-.8 1.7c-.2.4-.1.9.2 1.2l2.6 2.6c.3.3.8.4 1.2.2l1.7-.8c.6-.3 1.3-.1 1.6.5l1 1.8c.3.5.2 1.1-.2 1.5l-1.2 1.2c-.8.8-2 1.1-3 .7-2.7-1.1-5.1-2.9-7-4.9-2.1-1.9-3.9-4.3-5-7-.4-1 .-0.2-2.2.6-3l1.2-1.2Z"
          stroke="currentColor"
          strokeWidth="1.8"
          strokeLinecap="round"
          strokeLinejoin="round"
